...
class InstanceValidator {
  ...
  _perAttributeValidators() {
    ...
    _.forIn(this.modelInstance.rawAttributes, (rawAttribute, field) => {
      ...
      if (Object.prototype.hasOwnProperty.call(this.modelInstance.validators, field)) {
        validators.push(Utils.reflectPromise(this._singleAttrValidate(value, field, rawAttribute.allowNull)));
      }
    });
  ...
  _customValidators() {
    ...
    _.each(this.modelInstance._modelOptions.validate, (validator, validatorType) => {
      ...
      validators.push(Utils.reflectPromise(this._invokeCustomValidator(validator, validatorType).catch(() => { })));
    });
  ...
  _singleAttrValidate(value, field, allowNull) {
    ...
    _.forIn(this.modelInstance.validators[field], (test, validatorType) => {
      ...
      if (typeof test === 'function') {
        validators.push(Utils.reflectPromise(this._invokeCustomValidator(test, validatorType, true, value, field)));
        return;
      }
      ...
      validators.push(Utils.reflectPromise(validatorPromise));
    });
